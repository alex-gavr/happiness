...
import { ImageContainer, OptionsContainer, StyledEmoji, StyledHeading, StyledStrong } from '@/styles/styled';
                                        ...
                                        {agree ? (
                                            ...
                                            <IDKContainer onClick={() => handleClick(answer)}>
                                                <p
                                                    style={
                                                        pathname === '/6'
                                                            ? { textTransform: 'capitalize', textAlign: 'center', fontSize: 'clamp(0.8rem, 0.7000rem + 0.5333vw, 1.2rem)' }
                                                            : { textTransform: 'capitalize', textAlign: 'center' }
                                                    }>
                                                    {answer.answer}
                                                </p>
